...
\textcolor{corSubSection}{Arquitetura:}
Clean Code, SOLID, Design Patterns,
Arquitetura de microsserviços, APIs REST,
Design de Módulos, Testabilidade,
lambda serverless ou kubernets na AWS;
Conhecimentos em modelo arquitetural port and adapters e conceito hexagonal.
...
MySQL, PostgreSQL, DynamoDB, e SQLite;
NoSQL como
MongoDB, Redis;
ORM como
